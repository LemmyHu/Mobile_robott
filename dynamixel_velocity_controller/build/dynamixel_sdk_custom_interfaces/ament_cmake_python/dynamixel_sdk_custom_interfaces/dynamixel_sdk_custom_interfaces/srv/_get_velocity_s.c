...
bool dynamixel_sdk_custom_interfaces__srv__get_velocity__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_sdk_custom_interfaces.srv._get_velocity.GetVelocity_Request", full_classname_dest, 69) == 0);
  }
  dynamixel_sdk_custom_interfaces__srv__GetVelocity_Request * ros_message = _ros_message;
  {  // ids
...
PyObject * dynamixel_sdk_custom_interfaces__srv__get_velocity__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_sdk_custom_interfaces.srv._get_velocity");
...
ROSIDL_GENERATOR_C_EXPORT
bool dynamixel_sdk_custom_interfaces__srv__get_velocity__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_sdk_custom_interfaces.srv._get_velocity.GetVelocity_Response", full_classname_dest, 70) == 0);
  }
  dynamixel_sdk_custom_interfaces__srv__GetVelocity_Response * ros_message = _ros_message;
  {  // velocities
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->velocities.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
...
PyObject * dynamixel_sdk_custom_interfaces__srv__get_velocity__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // velocities
    ...
    if (ros_message->velocities.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->velocities.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->velocities.size * sizeof(int32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
