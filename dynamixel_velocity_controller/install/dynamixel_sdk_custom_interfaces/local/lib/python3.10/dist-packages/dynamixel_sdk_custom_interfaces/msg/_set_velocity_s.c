...
bool dynamixel_sdk_custom_interfaces__msg__set_velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_sdk_custom_interfaces.msg._set_velocity.SetVelocity", full_classname_dest, 61) == 0);
  }
  dynamixel_sdk_custom_interfaces__msg__SetVelocity * ros_message = _ros_message;
  {  // ids
...
{
  /* NOTE(esteve): Call constructor of SetVelocity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_sdk_custom_interfaces.msg._set_velocity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetVelocity");
